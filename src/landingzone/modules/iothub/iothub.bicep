...
@minLength(1)
@maxLength(11)
param baseName string = 'zurusesfm'
...
var iotHubName = '${baseName}Hub${uniqueString(resourceGroup().id)}'
var storageAccountName = '${toLower(baseName)}${uniqueString(resourceGroup().id)}'
var storageEndpoint = '${baseName}StorageEndpont'
var storageContainerName = '${toLower(baseName)}results'
